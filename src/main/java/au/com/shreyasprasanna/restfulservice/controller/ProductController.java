package au.com.shreyasprasanna.restfulservice.controller;

import au.com.shreyasprasanna.restfulservice.controller.model.ProductID;
import au.com.shreyasprasanna.restfulservice.model.Product;
...
public class ProductController {
    ...
    public List<Product> getAllProducts() {
        ...
        result.add(new Product("1",
                "Product1",
                new BigDecimal("255.80")));

        result.add(new Product("2",
                "Product2",
                new BigDecimal("207.80")));

        result.add(new Product("3",
                "Product3",
                new BigDecimal("300.80")));
